...
export const BackgroundRippleEffect = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-babyshopSky/5 via-transparent to-babyshopPurple/5" />

  ...
  return (
    ...
    >
      <motion.div
        ...
        ref={sidebarRef}
        className="min-w-72 max-w-96 bg-babyshopWhite text-babyshopBlack z-50 h-screen border-r border-r-tech_orange flex flex-col gap-6 relative"
      >
        <div className="flex items-center justify-between border-b pb-4 p-5">
        ...
        <button
          onClick={onClose}
          className="text-babyshopWhite hover:text-babyshopRed hoverEffect absolute top-3 -right-7"
        >
          <X />
        </button>
      </motion.div>

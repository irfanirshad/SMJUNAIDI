  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full bg-linear-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-linear-to-tl from-indigo-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      >
        ...
        >
          ...
          Secure admin access with encrypted communication
        </motion.p>
      </motion.div>
    </div>
  );
